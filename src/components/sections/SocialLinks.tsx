...
const SocialLinks = () => {
  return (
    <div className="flex justify-center gap-6 py-6 fade-in">
      <a 
        href="https://www.facebook.com/share/1GK3MJ1WQw/?mibextid=wwXlfr" 
        target="_blank" 
        rel="noopener noreferrer"
        className="flex flex-col items-center text-gray-600 hover:text-gray-900 transition-colors hover:scale-110 transform duration-200"
      >
        <Facebook size={32} />
